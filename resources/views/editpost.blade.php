        ...
        <form method="POST" action="{{ Route('post.update') }}" enctype="multipart/form-data">
           ...
           value="{{ $post->id }}" >
            ...
            <div class="mb-4">
                ...
                <textarea id="content" name="content" type="text" placeholder="Post content goes here"
            ...
            <div class="flex items-center mb-4">
                ...
                <image name="imgpreview" id="imgpreview"
                    class="h-52 w-72 mr-12 bg-gray-200 object-scale-down overflow-hidden" src="{{asset('/storage/post_images/'.$post->image)}}"></image>
            ...
            <div class="flex flex-row items-center justify-end">
                ...
                <a href="{{ route('home')}}"
                    class="w-1/6 text-center mr-3 select-none whitespace-no-wrap p-3 rounded-md text-base no-underline text-gray-600 bg-gray-300 hover:bg-gray-200 sm:py-4 transition-all duration-300" >Cancel</a>

                <input type="submit" value="Update"
                    class="cursor-pointer w-1/4 text-center ml-3 select-none whitespace-no-wrap p-3 rounded-md text-base no-underline text-gray-100 bg-primary hover:bg-primary-light sm:py-4 transition-all duration-300" />
